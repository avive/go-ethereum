...
func (in *Interpreter) Run(snapshot int, contract *Contract, input []byte) (ret []byte, err error) {
	...
	log.Debug("interpreter running contract", "hash", codehash.String())
	tstart := time.Now()
	defer log.Debug("interpreter finished running contract", "hash", codehash.String(), "elapsed", time.Since(tstart))
